...
public:
  OdomNode() : Node("odomnode") {
    ...
    sub_ = this->create_subscription<
        ...
        "dynamixel_workbench/dynamixel_state", 10,
        std::bind(&OdomNode::chatterCallback, this, _1));
    ...
    timer_ = this->create_wall_timer(std::chrono::milliseconds(100),
                                     std::bind(&OdomNode::odomupdate, this));
  }
...
private:
  void chatterCallback(
    ...
    // TODO: Verify if the indices are always 0 and 1 for Left/Right
    ...
    Leftw = Leftrpm * 0.114 * 0.10471975511;
    Rightw = rightrpm * 0.114 * 0.10471975511;
  }

  void odomupdate() {
    double vth = 0.0485 * ((Rightw - Leftw) / 0.31);
    double v = 0.0485 * ((Rightw + Leftw) / 2.0);
